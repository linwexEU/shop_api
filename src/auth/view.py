...
async def authenticate(
    response: Response, users_service: UsersServiceDep, data: SUsersAuth
) -> SUsersAuthResponse:
...
async def registration(
    users_service: UsersServiceDep, data: SUsersRegistration
...
async def google_oauth_callback(
    request: Request, response: Response, users_service: UsersServiceDep
) -> SUsersAuthResponse:
    flow = AuthFlow(users_service)
