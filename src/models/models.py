...
from src.models.enums import ActEnum, CategoriesEnum, NotificationsStateEnum, NotificationsTypeEnum, OrdersStateEnum, UsersRoleEnum
...
class Users(Base): 
    ...
    role: Mapped[UsersRoleEnum] = mapped_column(Enum(UsersRoleEnum), default=UsersRoleEnum.Customer)
...
class Organizations(Base): 
    ...
    delete_utc: Mapped[datetime] = mapped_column(TIMESTAMP(timezone=True), nullable=True)
...
class Products(Base): 
    ...
    category: Mapped[CategoriesEnum] = mapped_column(Enum(CategoriesEnum), nullable=False)
...
class Orders(Base): 
    ...
    state: Mapped[OrdersStateEnum] = mapped_column(Enum(OrdersStateEnum), default=OrdersStateEnum.Preparing)
    create_utc: Mapped[datetime] = mapped_column(TIMESTAMP(timezone=True), default=datetime.now(timezone.utc))
    delete_utc: Mapped[datetime] = mapped_column(TIMESTAMP(timezone=True), nullable=True)
...
class Notifications(Base): 
    ...
    state: Mapped[NotificationsStateEnum] = mapped_column(default=NotificationsStateEnum.New)
