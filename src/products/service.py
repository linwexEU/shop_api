from src.products.schema import SProductFilters, SProductsModel, SProductsSearch
...
class ProductsService: 
    ...
    async def get_by_filters(self, filters: SProductFilters, one: bool = True): 
        return await self.prod_repo.get_by_filters(filters.model_dump(exclude_none=True), one)
